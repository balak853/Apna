...
def build_profile_output(uid: str, payloads: list[Any]) -> str:
    ...
    return (
        ...
        f"├─ ❤️ Likes    : {value('likes', 'like', 'likecount', 'totallikes')}\n"
        f"├─ 🎖️ Badges   : {value('badges', 'badge', 'badgecount')}\n"
        f"├─ 💎 Prime    : {value('prime', 'primelevel', 'prime_level')}\n"
        f"└─ 🎮 Version  : {value('version', 'gameversion')}\n\n"
        "┌─ 📅 ACCOUNT INFORMATION\n"
        f"├─ 🗓️ Created  : {value('created', 'createdat', 'accountcreated', 'createddate')}\n"
        f"├─ 🕐 Last Login : {value('lastlogin', 'lastlogindate', 'lastseen')}\n"
        f"└─ 🎟️ Elite Pass : {value('elitepass', 'elite_pass', 'elitepasslevel')}\n\n"
        "┌─ 🏆 RANK INFORMATION\n"
        f"├─ 🔥 BR Rank       : {value('brrank', 'br_rank', 'battleroyalerank')}\n"
        f"├─ 📊 BR Points     : {value('brpoints', 'br_points', 'battleroyalepts')}\n"
        f"├─ 🏆 BR Max Rank   : {value('brmaxrank', 'br_max_rank')}\n"
        ...
        f"├─ 👥 Members       : {value('members', 'guildmembers', 'membercount')}\n"
        f"└─ 👑 Captain       : {value('captain', 'guildcaptain', 'leader')}\n\n"
        "┌─ 🐾 PET INFORMATION\n"
        f"├─ 🐾 Pet           : {value('pet', 'petname')}\n"
        f"├─ ⭐ Level         : {value('petlevel', 'pet_level')}\n"
        f"├─ ✨ EXP           : {value('petexp', 'pet_exp')}\n"
        f"└─ ⚡ Status        : {value('petstatus', 'pet_status')}\n\n"
        "┌─ ⚡ LOADOUT\n"
        f"├─ ⚡ Skills        : {value('skills', 'skill', 'equippedskills')}\n"
        f"├─ 👕 Outfit        : {value('outfit', 'outfits')}\n"
        f"└─ 🔫 Weapon Skins : {value('weaponskins', 'weapon_skins', 'gunskins')}\n\n"
        "┌─ 📱 SOCIAL INFORMATION\n"
